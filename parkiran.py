...
st.markdown("""
    <style>
    /* 1. Warna Background Utama (Gradasi Unicorn Pastel) */
    .stApp {
        background: linear-gradient(135deg, #FFB7E8 0%, #B7E4FF 50%, #D4B7FF 100%);
        background-attachment: fixed;
    }
    
    /* 2. Styling Sidebar agar terlihat seperti kotak melayang */
    ...
    /* 3. Membuat konten utama (Dashboard/Tabel) lebih rapi dengan latar putih */
